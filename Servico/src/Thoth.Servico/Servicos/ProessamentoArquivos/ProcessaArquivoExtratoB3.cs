...
public class ProcessaArquivoExtratoB3 : IProcessaArquivo
{
    private ILogger<ProcessaArquivoExtratoB3> _logger;

    public string TipoArquivo => "ExtratoB3";

    public ProcessaArquivoExtratoB3(ILogger<ProcessaArquivoExtratoB3> logger)
    {
        _logger = logger;
    }

    public IEnumerable<ItemExtrato> ObterItensExtrato(Arquivo arq)
    {
        using var workbook = new XLWorkbook(arq.Caminho);
